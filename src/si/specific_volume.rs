...
quantity! {
    ...
    units {
        ...
        @gallon_per_grain: 5.841_783_449_752_474_E1; "gal/gr",
            "gallon per grain", "gallons per grain";
        @cubic_centimeter_per_gram: 1.0_E-3; "cm³/g",
        ...
        @cubic_inch_per_ounce: 5.780_365_946_231_19_E-4; "in³/oz",
            "cubic inch per ounce", "cubic inches per ounce";
        @gallon_imperial_per_ounce:1.603_586_233_558_804_4_E-1; "gal (UK)/oz",
            "Imperial gallon per ounce", "Imperial gallons per ounce";
        @gallon_per_ounce: 1.335_264_935_702_615_E-1; "gal/oz",
            "gallon per ounce", "gallons per ounce";
        @cubic_foot_per_pound: 6.24_279_639_605_954_6_E-2; "ft³/lb",
            "cubic foot per pound", "cubic feet per pound";
        @cubic_inch_per_pound: 3.612_728_079_218_259_E-5; "in³/lb",
            "cubic inch per pound", "cubic inches per pound";
        @cubic_yard_per_pound: 1.685_554_916_704_953_7_E0; "yd³/lb",
            "cubic yard per pound", "cubic yards per pound";
        @gallon_imperial_per_pound: 1.002_241_219_209_140_1_E-2; "gal (UK)/lb",
            "Imperial gallon per pound", "Imperial gallons per pound";
        @gallon_per_pound: 8.345_404_376_263_8_E-3; "gal/lb",
            "gallon per pound", "gallons per pound";
        @cubic_foot_per_slug: 1.940_320_956_015_869_7_E-3; "ft³/slug",
            "cubic foot per slug", "cubic feett per slug";
...
mod tests {
    storage_types! {
        ...
        fn check_units() {
            ...
            test::<a::cubic_meter, m::hundredweight_long, sv::cubic_meter_per_hundredweight_long>();
            test::<a::cubic_meter, m::hundredweight_short, sv::cubic_meter_per_hundredweight_short>();
